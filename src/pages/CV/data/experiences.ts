export type HistoryItem = FormationItem | ExperienceItem
...
export const isItemExperience = (item: HistoryItem): item is ExperienceItem =>
    !!(item as ExperienceItem).job
